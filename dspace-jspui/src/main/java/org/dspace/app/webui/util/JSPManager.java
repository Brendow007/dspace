...
public class JSPManager
{
    ...
    public static void showCustomizeExceptionError(HttpServletRequest request,
            HttpServletResponse response, String exceptionMenssage, int type)
            throws ServletException, IOException
    {
        request.setAttribute("bad.id", StringEscapeUtils.escapeHtml(exceptionMenssage));
        response.setStatus(HttpServletResponse.SC_NOT_FOUND);
