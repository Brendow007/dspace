...
public class SelectEPersonTag extends TagSupport
{
    ...
    public int doStartTag() throws JspException
    {
        try
        {
            ...
            out.print("<select id=\"selectEperson\" class=\"form-control\" multiple=\"multiple\" name=\"eperson_id\" size=\"");
            ...
            //out.print("<option/>");
            out.print("</select>");
            out.print("<div class=\"row container\">");
            String p = (multiple ? 
            ...
            out.print("<br/><input class=\"btn btn-primary\" type=\"button\" value=\"" + p
