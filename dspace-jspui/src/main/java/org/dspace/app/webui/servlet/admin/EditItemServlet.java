...
//        String checkboxValues[] = request.getParameterValues("acceptTerm");
//
//        Boolean isTermAccepted = (checkboxValues != null && checkboxValues.length == 1 && Boolean.valueOf(checkboxValues[0]));
...
//            request.setAttribute("accept.term", isTermAccepted);
    ...
    protected void doDSPost(Context context, HttpServletRequest request,
        ...
        switch (action) {
            ...
            case UPDATE_CC:
                ...
                if (licenseclass.equals("standard") && isTermAccepted) {
                ...
                int ii = item.getID();
                Boolean policyExists = ResourcePolicy.CheckReadPolicyExists(context, ii);
                if (!policyExists) {
                    ...
                    ResourcePolicy policyy = ResourcePolicy.find(context, policy.getID());
                    AuthorizeUtil.authorizeManagePolicy(context, policyy);
                    ...
                    if (itemId != -1) {
                        ...
                        // modify the policy
                        policyy.setAction(0);
                        policyy.setGroup(group);

                        policyy.setStartDate(null);
                        policyy.setEndDate(null);
                        policyy.update();
