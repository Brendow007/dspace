...
<% StatisticsBean statsMonthlyVisits = (StatisticsBean) request.getAttribute("statsMonthlyVisits"); %>
...
<dspace:layout titlekey="jsp.statistics.title">
    ...
    <p>General:
        <br>Visitors Monthly: <%= statsMonthlyVisits.getName()%>
        <br>field Matrix: <%= statsMonthlyVisits.getMatrix()%>
        <br>field Col-Labels:   <%= statsMonthlyVisits.getColLabels()%>
        <br>field RowLabels:  <%= statsMonthlyVisits.getRowLabels()%>
        <br>Fields: <%= statsMonthlyVisits.getHits()%>
