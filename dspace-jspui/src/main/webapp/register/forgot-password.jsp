    ...
    <form class="form-horizontal" action="<%= request.getContextPath() %>/forgot" method="post">
        <input type="hidden" name="step" value="<%= RegisterServlet.ENTER_EMAIL_PAGE %>"/>
					...
					<div class="form-group"><br/>
            			<label class="col-md-4 control-label" for="temail"><fmt:message key="jsp.register.forgot-password.email.field"/></label>
            			<div class="col-md-6">
            				<input class="form-control" required="required" type="email" name="email" id="temail" />
            			</div>
            		</div>                    
					<div class="row">
        				<div class="col-md-6">
