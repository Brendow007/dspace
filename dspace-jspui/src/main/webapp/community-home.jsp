...
%>
		<small><fmt:message key="jsp.community-home.heading1"/></small><br/>
		</h2>
       <h4> <% if (StringUtils.isNotBlank(intro)) { %>
        <%= intro %>
           <% } %></h4>
...
<%  if (logo != null) { %>
     <div class="col-md-4">
     	<img class="img-logo" alt="Logo" src="<%= request.getContextPath() %>/retrieve/<%= logo.getID() %>" />
     </div>
<% } %>
 </div>
...
<p class="p-community"><%= copyright %></p>
	<div class="row">
<%
	if (rs != null)
	{ %>
	<div class="hide col-md-8">
...
<%-- Browse --%>
<div class="hide panel panel-primary">
