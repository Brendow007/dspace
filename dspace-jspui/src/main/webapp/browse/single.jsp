...
<div id="contentBrowser" class="listContentBrowser">
...
<% 
	...
	{
%>
	<a class="btn btn-sm btn-primary pull-left" href="<%= prev %>"> <fmt:message key="browse.single.prev"/></a>&nbsp;
<%
	}
%>
...
<%
	...
	{
%>
	&nbsp;<a class="btn btn-sm btn-primary pull-right" href="<%= next%>"><fmt:message key="browse.single.next"/> </a>
<%
	}
%>
	</div>
