...
%>
        ...
        <input type="submit" class="btn btn-primary" value="<fmt:message key="browse.nav.go"/>" />
...
%><br/><br/>
	    					...
	    					<input type="text" name="starts_with"/>&nbsp;<input type="submit" class="btn btn-success" value="<fmt:message key="browse.nav.go"/>" />
<%
	}
%>
	</form>
...
%>
		...
		<input type="submit" class="btn btn-primary" name="submit_browse" value="<fmt:message key="jsp.general.update"/>"/>

<%
    if (admin_button && !withdrawn && !privateitems)
    {
        %><input type="submit" class="btn btn-warning" name="submit_export_metadata" value="<fmt:message key="jsp.general.metadataexport.button"/>" /><%
    }
%>
...
<%
	...
	{
%>
	<a class="btn btn-sm btn-primary pull-left" href="<%= prev %>"><fmt:message key="browse.full.prev"/></a>&nbsp;
<%
	}
%>
...
<%
	...
	{
%>
	&nbsp;<a class="btn btn-sm btn-primary pull-right" href="<%= next %>"><fmt:message key="browse.full.next"/></a>
<%
	}
%>
	</div>
