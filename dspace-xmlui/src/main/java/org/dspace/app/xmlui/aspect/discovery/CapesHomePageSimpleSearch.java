...
public class CapesHomePageSimpleSearch extends AbstractSearch implements CacheableProcessingComponent {
    /**
     * Language Strings
     */
...
//            message("xmlui.discovery.SimpleSearch.search_label");
    ...
    private static final Message T_filter_label = message("xmlui.Discovery.SimpleSearch.search_scope");
    private static final Message T_filter_help = message("xmlui.Discovery.CapesHomePageSimpleSearch.filter_help");
    ...
    public CapesHomePageSimpleSearch() {
    ...
    public void addBody(Body body) throws SAXException, WingException,
        ...
        Division mainSearchDiv = searchBoxDivision.addInteractiveDivision("general-query",
                "discover", Division.METHOD_GET, "discover-search-box hidden");
