...
public class DiscoverySearchRequestProcessor implements SearchRequestProcessor {
    ...
    protected void getAllCollCom(Context context,
        ...
        request.setAttribute("communitiees", communities);
        request.setAttribute("collectioons.map", colMap);
        request.setAttribute("subcommunitiees.map", commMap);
