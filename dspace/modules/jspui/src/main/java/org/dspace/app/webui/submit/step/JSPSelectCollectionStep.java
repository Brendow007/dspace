...
public class JSPSelectCollectionStep extends JSPStep {
    ...
    public void doPreProcessing(Context context, HttpServletRequest request,
        ...
        ItemIterator itemIterator = Item.findBySubmitterDC(context, context.getCurrentUser());
        ...
        if (col != null && isTermAccepted) {
            ...
            request.setAttribute("must.accept.term", (!itemIterator.hasNext()));
