...
<%
    ...
    String maxUploadSizeString = ConfigurationManager.getProperty("upload.max");
    Integer maxUploadSize = maxUploadSizeString != null ? (Integer.parseInt(maxUploadSizeString) / 1048576) : 0;
%>
...
<dspace:layout style="submission"
    ...
    <form id="uploadForm" <%= bSherpa?"class=\"sherpa col-md-8\"":"" %> method="post" 
        ...
        <div class="submitFormHelp">
            <fmt:message key="jsp.submit.choose-file.info10">
                <fmt:param><%= maxUploadSize %></fmt:param>
            </fmt:message>
            <dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.break-file\")%>"><fmt:message key="jsp.submit.choose-file.info11"/></dspace:popup>
        </div>
        <br/>
