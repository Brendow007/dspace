...
<dspace:layout style="submission" titlekey="jsp.register.edit-profile.title" nocache="true">
	...
	<h1 align="center"><fmt:message key="jsp.register.edit-profile.title"/>
	<dspace:popup page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.index\") + \"#editprofile\"%>"><span class="glyphicon glyphicon-question-sign"></span></dspace:popup>
	</h1>
