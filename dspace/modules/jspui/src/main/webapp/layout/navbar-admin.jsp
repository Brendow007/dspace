...
<div class="navbarAdmin">
    ...
    <ul class="nav navbar-nav">
        <li><a href="<%= request.getContextPath()%>/"><span class="glyphicon glyphicon-home"></span> <fmt:message
                key="jsp.layout.navbar-default.home"/></a></li>

        <%if (isAdmin) {%>
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message
                    key="jsp.layout.navbar-admin.contents"/> <b class="caret"></b></a>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu">
                    <a class="test" tabindex="-1" href="#"><fmt:message key="jsp.layout.navbar-admin.author"/><span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a tabindex="-1"
                               href="<%= request.getContextPath()%>/register/manage-authors?operation=list"><fmt:message
                                key="jsp.layout.navbar-admin.author.inactive"/></a></li>
                        <li><a tabindex="-1"
                               href="<%= request.getContextPath()%>/register/manage-authors?operation=active"><fmt:message
                                key="jsp.layout.navbar-admin.author.active"/></a></li>
                    </ul>
                </li>
            </ul>
        </li>
        ...
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message
                    key="jsp.layout.navbar-admin.report"/> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a href="<%= request.getContextPath()%>/report/submission?operation=form"><fmt:message
                        key="jsp.layout.navbar-admin.report.submission"/></a></li>
            </ul>
        </li>

        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message
                    key="jsp.layout.navbar-admin.resource"/> <b class="caret"></b></a>
            <ul class="dropdown-menu">
                <li><a href="<%= request.getContextPath()%>/partners"><fmt:message
                        key="jsp.layout.navbar-admin.partners"/></a></li>
                <li><a tabindex="-1" href="<%= request.getContextPath()%>/faq"><fmt:message
                        key="jsp.layout.navbar-admin.faq"/></a></li>
                <li><a tabindex="-1" href="<%= request.getContextPath()%>/dspace-admin/manager-repository"><fmt:message
                        key="jsp.layout.navbar-admin.manager-repo"/></a></li>
                <li><a tabindex="-1" href="<%= request.getContextPath()%>/dspace-admin/manager-profile"><fmt:message
                        key="jsp.layout.navbar-admin.manager-profiles"/></a></li>
                <li><a tabindex="-1" href="<%= request.getContextPath()%>/dspace-admin/index-manager"><fmt:message
                        key="jsp.layout.navbar-admin.manager-indexer"/></a></li>
                <li><a tabindex="-1" href="<%= request.getContextPath()%>/poll?operation=list"><fmt:message
                        key="jsp.layout.navbar-admin.author.poll"/></a></li>
                <li><a href="<%= request.getContextPath()%>/dspace-admin/news-edit"><fmt:message
                        key="jsp.layout.navbar-admin.editnews"/></a></li>



            </ul>
        </li>
        <li><a href="<%= request.getContextPath()%>/statistics"><fmt:message
                key="jsp.layout.navbar-admin.statistics"/></a></li>
        <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><fmt:message
                    key="jsp.layout.navbar-admin.settings"/> <b class="caret"></b></a>
            <ul class="dropdown-menu">
        ...
        <li class="<%= (currentPage.endsWith("/help") ? "active" : "")%>"><dspace:popup
                page="<%= LocaleSupport.getLocalizedMessage(pageContext, \"help.site-admin\") %>"><fmt:message
                key="jsp.layout.navbar-admin.help"/></dspace:popup></li>
    </ul>
    <%}%>
        ...
        <ul class="nav navbar-nav navbar-right pull-right">
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span
                        class="glyphicon glyphicon-user"></span> <%= StringUtils.abbreviate(navbarEmail, 20)%> <b
                        class="caret"></b></a>
                <ul class="dropdown-menu">
