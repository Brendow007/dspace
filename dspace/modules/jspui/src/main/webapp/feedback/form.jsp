...
<dspace:layout title="feedback" style="submission" locbar="link"
               parentlink="/"
               titlekey="jsp.feedback">
...
%>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/static/css/jquery-ui.css" type="text/css" />
    ...
    <div  style="background:#346ebc" id="dialog"  title="Nos avalie" >
