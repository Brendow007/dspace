...
(function ($) {
    ...
    function initializeFilters() {
        ...
        $('a[href="display-filters"]').click(function () {
            ...
            var showFilterLink = $(this);

            filtersForm.show();
            filtersForm.css('visibility', 'visible');
            //filtersForm.append("<a href='hide-filters'>Ocultar filtros</a>");

//            $('a[href="hide-filters"]').click(function(){
//                filtersForm.hide();
//                filtersForm.css('visibility', 'hidden');
//                showFilterLink.show();
...
//            });
        ...
        $('a[href="hide-filters"]').click(function () {
            var filtersForm = $('form#aspect_discovery_SimpleSearch_div_search-filters');
            var showFilterLink = $('form#aspect_discovery_SimpleSearch_div_general-query').find('a');
