    ...
    <xsl:template match="dri:options">
        <xsl:if test="$request-uri != ''">
            <div id="navigation">
                ...
                <!--<span class="logoUAB">Logo Universidade Aberta do Brasil</span>-->
                <aside>
                    <div id="ds-options">
                        	
                        <xsl:apply-templates/>
                        
                        <h2 class="ds-option-set-head"><i18n:text>xmlui.send.material.header</i18n:text></h2>
                        <div id="aspect_viewArtifacts_Navigation_list_account" class="ds-option-set" xmlns="http://di.tamu.edu/DRI/1.0/" xmlns:i18n="http://apache.org/cocoon/i18n/2.1">
                            <ul class="ds-simple-list">
                                <li>
                                    <a>
                                        <xsl:attribute name="href">
                                            <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='contextPath'][not(@qualifier)]"/>
                                            <xsl:text>/page/submission</xsl:text>
                                        </xsl:attribute>
                                        <i18n:text>xmlui.send.material</i18n:text>
                                    </a>
                                </li>
                            </ul>
                        </div>
