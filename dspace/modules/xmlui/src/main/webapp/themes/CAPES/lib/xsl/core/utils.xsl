...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template match="dri:reference" mode="summaryList">
        ...
        <!--<xsl:variable name="authenticated" select="/dri:document/dri:meta/dri:userMeta/@authenticated = 'yes'" />
        <xsl:if test="$authenticated or (@url != '/metadata/handle/capes/1/mets.xml')">-->
            <li>
