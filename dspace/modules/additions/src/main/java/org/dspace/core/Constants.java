...
public class Constants {
    ...
    /**
     * Type of individual author objects
     */
    ...
    public static final int FAQGROUP = 11;

    public static final int PARTNERS = 12;

    public static final int METADATAPROFILEVALUES = 13;

    /**
     * lets you look up type names from the type IDs
     */
    public static final String[] typeText = {"BITSTREAM", "BUNDLE", "ITEM",
        "COLLECTION", "COMMUNITY", "SITE", "GROUP", "EPERSON", "AUTHOR", "POLL","FAQ","FAQGROUP"};
