...
public abstract class DSpaceObject
{
   ...
   /* public double getItemEvaluation(int pitemId)throws SQLException {

        double avgGrade = -1.0;
        TableRowIterator tri = DatabaseManager.queryTable(ourContext, "itemEvaluation",
                "SELECT AVG(grade) grade FROM itemEvaluation WHERE item_id = ?", pitemId);
        if (tri != null) {
            if (tri.hasNext()) {
                TableRow tr = tri.next();
                avgGrade = tr.getNumericColumn("grade").doubleValue();
                log.debug("Item evaluation: "+ tr.toString());
            }
        }
        return avgGrade;
    }*/

    public String getItemEvaluationHtml()throws SQLException {

        double avgGrade = -1.0;
        String html = "<span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span>";

        TableRowIterator tri = DatabaseManager.queryTable(ourContext, "itemEvaluation",
                "SELECT AVG(grade) grade FROM itemEvaluation WHERE item_id = ?", this.getID());
        if (tri != null) {
            if (tri.hasNext()) {
                TableRow tr = tri.next();
                avgGrade = tr.getNumericColumn("grade").doubleValue();
        ...
        tri = DatabaseManager.queryTable(ourContext, "itemEvaluation",
                "SELECT count(1) item_id FROM itemEvaluation WHERE item_id = ?", this.getID());

        String c1 = "0";
        if (tri != null) {
            if (tri.hasNext()) {
                TableRow tr = tri.next();
                c1 = tr.getNumericColumn("item_id").toString();
            }
        }
        ...
        if (avgGrade == -1) {
            return html + "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        } else if (avgGrade <= 1) {
            return "<span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span>"+ "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        }else if(avgGrade<= 2){
            return "<span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span>"+ "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        }else if(avgGrade<= 3){
            return "<span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span>"+ "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        }else if(avgGrade<= 4){
            return "<span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#a9a9a9;\">&#9733;</span>"+ "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        }else if(avgGrade<= 5){
            return "<span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span><span style=\"color:#ffa500;\">&#9733;</span>"+ "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
        }

        return html + "&nbsp;<span style=\"color:#a9a9a9;\">("+c1+")</span>";
    }

    public int getItemEvaluation()throws SQLException {
    ...
    public void insertItemEvaluation(int grade, int pitemId, String user)throws SQLException {

        ItemEvaluation item = new ItemEvaluation();
        item.setGrade(grade);
        item.setItemId(pitemId);
        try {
            item.create(ourContext);
