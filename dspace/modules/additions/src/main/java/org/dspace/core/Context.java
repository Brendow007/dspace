...
public class Context {
    ...
    /**
     * Construct a new context object with passed options. A database connection
     * is opened. No user is authenticated.
     *
     ...
     * @param b if <code>true</code>, authorisation should be ignored for this
     * session.
     */
     ...
     * @exception SQLException if there was an error completing the database
     * transaction or closing the connection
     * @exception IllegalStateException if the Context is read-only or is no
     * longer valid
     */
    ...
    /**
     * Retrieves the first element in the events list & removes it from the list
     * of events once retrieved
     *
     ...
     *
     * @param objectClass Java Class of object to check for in cache
